      ...
      const res = await axios.post("employee/insert", {
        ...
        insert_json: {
          ...
          "Proficiency in Backend Technologies ":
            values.Proficiency_in_Backend_Technologies,
          "Knowledge of Frontend Frameworks":
            values.Knowledge_of_Frontend_Frameworks,
          "Knowledge of Backend Frameworks":
            values.Knowledge_of_Backend_Frameworks,
          "Database Management (SQL, NoSQL)": values.Database_Management,
          "API Development and Integration":
            values.API_Development_and_Integration,
          "Years of experience in Fullstack engineer":
            values.Years_of_experience_in_Fullstack_Engineer,
    ...
    <div>
      <div className="mt-10">
        ...
        <Form form={form} name="common" onFinish={onFinish} autoComplete="off">
          ...
          <Form.Item
            label="Proficiency in Frontend Technologies"
            name="Proficiency_in_Frontend_Technologies"
            rules={[
              {
                required: true,
                message: "Please input Proficiency in Frontend Technologies!",
              },
            ]}
            style={{ width: "48%" }}
          >
          ...
          <div className="flex flex-row justify-between">
            <Form.Item
              label="Proficiency in Backend Technologies"
              name="Proficiency_in_Backend_Technologies"
              rules={[
                {
                  required: true,
                  message:
                    "Please input Proficiency in Proficiency in Backend Technologies",
                },
              ]}
              style={{ width: "48%" }}
            >
            ...
            <Form.Item
              label="Knowledge of  Frontend Frameworks"
              name="Knowledge_of_Frontend_Frameworks"
              rules={[
                {
                  required: true,
                  message: "Please Input Knowledge of  Frontend Frameworks!",
                },
              ]}
              style={{ width: "48%" }}
            >
          ...
          <div className="flex flex-row justify-between">
            <Form.Item
              label="Knowledge of Backend Frameworks"
              name="Knowledge_of_Backend_Frameworks"
              rules={[
                {
                  required: true,
                  message: "Please input Knowledge of Backend Frameworks!",
                },
              ]}
              style={{ width: "48%" }}
            >
          ...
          <div className="flex flex-row justify-between">
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please input API Development and Integration!",
                },
              ]}
              style={{ width: "48%" }}
            >
            ...
            <Form.Item
              label="Years of experience in FullStack Engineer"
              name="Years_of_experience_in_Fullstack_Engineer"
              rules={[
                {
                  required: true,
                  message:
                    "Please input Years of experience in FullStack Engineer!",
                },
              ]}
              style={{ width: "48%" }}
            >
