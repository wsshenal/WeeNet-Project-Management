    ...
    try {
      const res = await axios.post("employee/insert", {
        ...
        insert_json: {
          ...
          "Risk Management": values.Risk_Management,
          "Budgeting and Cost Control": values.Budgeting_and_Cost_Control,
          "Knowledge of Project Management Methodologies":
            values.Knowledge_of_Project_Management_Methodologie,
          "Years of experience in Fullstack engineer":
            values.Years_of_experience_in_Project_Manager,
        ...
        <Form form={form} name="common" onFinish={onFinish} autoComplete="off">
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input planning & scheduling!",
              },
            ]}
            style={{ width: "48%" }}
          >
          ...
          <Form.Item
            label="Knowledge of Project Management Methodologie"
            name="Knowledge_of_Project_Management_Methodologie"
            rules={[
              {
                required: true,
                message:
                  "Please input Knowledge_of_Project_Management_Methodologie!",
              },
            ]}
            style={{ width: "48%" }}
          >
          ...
          <div className="flex flex-row justify-between">
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please input Risk Management!",
                },
              ]}
              style={{ width: "48%" }}
            >
            ...
            <Form.Item
              ...
              name="Budgeting_and_Cost_Control"
              rules={[
                {
                  required: true,
                  message: "Please input Budgeting and Cost Control",
                },
              ]}
              style={{ width: "48%" }}
            >
          ...
          <div className="flex flex-row justify-between">
            <Form.Item
              label="Years of experience in Project Manager"
              name="Years_of_experience_in_Project_Manager"
              rules={[
                {
                  required: true,
                  message:
                    "Please input Years of experience in Project Manager!",
                },
              ]}
              style={{ width: "48%" }}
            >
